...
1. Generate fuzz targets for url.
    ...
    afl_scripts -p url
    ```
    **Note**: -p option is not always valid (Sadly, most time invalid). I recommend you to follow the [fuzz-target-generator instructions](https://github.com/cppbear/RuMono/blob/main/README.md) to generate targets.
